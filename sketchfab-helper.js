(function waitForSketchfab() {
  if (typeof Sketchfab === 'undefined') {
    console.log('[Helper] Sketchfab not yet ready, retrying...');
    return setTimeout(waitForSketchfab, 500);
  }

  console.log('[Helper] Sketchfab API found! Initializing...');
